...
seurat_obj <- bioc2022tidytranscriptomics::seurat_obj
...
seurat_obj |>
  ...
  mutate(gate = tidygate::gate_int(
    ...
    .size = 0.1, 
    .color =signature_score,
    gate_list = bioc2022tidytranscriptomics::gate_seurat_obj
  ))
...
seurat_obj |>
  ...
  mutate(gate = tidygate::gate_int(UMAP_1, UMAP_2, gate_list = bioc2022tidytranscriptomics::gate_seurat_obj)) |> 
...
pbmc = bioc2022tidytranscriptomics::seurat_obj_UMAP3
