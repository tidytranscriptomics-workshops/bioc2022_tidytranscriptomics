...
With `tidySummarizedExperiment` is easy to stratify our dataset for iterative self-contained analyses.
...
pseudo_bulk <-
  ...
  mutate(plot = map2(
    data, cell_type,
    ~ .x |>
      ggplot(aes(condition, counts_scaled + 1)) +
