...
We can select the gamma delta T cells, the red cluster on the left with high signature score. We'll filter for cells with a signature score > 0.8.
...
# Aggregate
pbmc_bulk <-
  bioc2022tidytranscriptomics::sce_obj %>%
  bioc2022tidytranscriptomics::aggregate_cells(file)
```
