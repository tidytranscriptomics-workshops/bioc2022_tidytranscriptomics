...
* If we use `select` we will also get any view-only columns returned, such as the UMAP, PCA columns generated during the preprocessing.
...
pseudo_bulk <-
  ...
  mutate(grouped_summarized_experiment = map(
    ...
    ~ .x |>
      ...
      test_differential_abundance(~treatment, method="edgeR_quasi_likelihood")
  ))
```
